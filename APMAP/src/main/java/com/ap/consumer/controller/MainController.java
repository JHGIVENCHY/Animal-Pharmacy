...
public class MainController {
    ...
    public MainController(MainService mainService){
        ...
        System.out.println("여기로 들어온거 확인.2");
    }
    
	@GetMapping("/map") //시작시 모든데이터가져옴
	public ModelAndView getAllAnimalPharmacy(@RequestParam(defaultValue = "1") int page, HttpServletRequest req1, HttpServletResponse res1){
		System.out.println("여기로 들어온거 확인.22");
